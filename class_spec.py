...
class serial_dilution():
    ...
    def setintegration(self, intTime) -> None:
        stepSize = 9999
    ...
    def read(self, wavelength, brightness) -> int:
        ...
        trans = (brightness/sesor_reading[wavelength])
        absorb = math.log(1/trans, base=10)
        print(absorb)
        return absorb
    ...
    def final_reading(self, wavelength: int, brightness_percentage: int = 100, integration_time : int = 100, sensor_gain : int = 7) -> dict:
        ...
        result_dict['ctrl'] = self.read(wavelength, brightness)
        for i in range(self.n_replicates):
            ...
            for j in range(self.n_samples-1):
                ...
                result_dict[f'replicate_{i}'][f'sample_{j+1}'] = self.read(wavelength, brightness)
        return(result_dict)